            ...
            <el-row class=" bgcolor shadow-border">
                ...
                <el-col :span="8" justify="center">
                    <div class="grid-content header">
                        餐厨垃圾处理设备<span class="subheading">铜山区柳泉镇5吨</span>
                    </div>
                </el-col>
                    ...
                    <div class="grid-content ep-bg-purple content-heigh">
                        <el-row gutter="10">
                            <el-col :span="6">
                                <div class="subbgcolor di-state-display left-first-line shadow-border">
                                    ...
                                    <div class="group-container">
                                        <!-- 第一个上料紧停是个常闭按钮 -->
                                        <DIOStateDisplay class="group-item" name="上料紧停按钮（常闭）"
                                        ...
                                        <DIOStateDisplay class="group-item" name="出料启动"
                                            :isWork="DI_state_bitArray[8]" />
                                        <DIOStateDisplay class="group-item" name="搅拌A正转"
                                            :isWork="DI_state_bitArray[9]" />
                                        <DIOStateDisplay class="group-item" name="搅拌A反转"
                                            :isWork="DI_state_bitArray[10]" />
                                        <DIOStateDisplay class="group-item" name="搅拌B正转"
                                            :isWork="DI_state_bitArray[11]" />
                                        <DIOStateDisplay class="group-item" name="破碎压榨正转"
                                            :isWork="DI_state_bitArray[12]" />
                                        <DIOStateDisplay class="group-item" name="破碎压榨反转"
                                            :isWork="DI_state_bitArray[13]" />
                                        <DIOStateDisplay class="group-item" name="液压泵"
                                            :isWork="DI_state_bitArray[14]" />
                                        <DIOStateDisplay class="group-item" name="不锈钢风机"
                                            :isWork="DI_state_bitArray[15]" />
                                        <DIOStateDisplay class="group-item" name="喷淋塔电机"
                                            :isWork="DI_state_bitArray[16]" />
                                        <DIOStateDisplay class="group-item" name="自吸式水泵"
                            ...
                            <el-col :span="12"
                                ...
                                <el-row>
                                    <div style="width: 100%">
                                        <img alt="设备图片" src="@/assets/kitchen waste.png"
                            ...
                            <el-col :span="6">
                                <div class="grid-content ep-bg-purple subbgcolor left-first-line shadow-border">
                                    ...
                                    <div class="group-container">
                                        <DIOStateDisplay class="group-item-DO" name="1#加热"
                                            :isWork="DO_state_bitArray[0]" />
                                        <DIOStateDisplay class="group-item-DO" name="2#加热"
                                            :isWork="DO_state_bitArray[1]" />
                                        <DIOStateDisplay class="group-item-DO" name="3#加热"
                                            :isWork="DO_state_bitArray[2]" />
                                        <DIOStateDisplay class="group-item-DO" name="4#加热"
                                            :isWork="DO_state_bitArray[3]" />
                                        <DIOStateDisplay class="group-item-DO" name="搅拌A正转"
                                            :isWork="DO_state_bitArray[8]" />
                                        <DIOStateDisplay class="group-item-DO" name="搅拌A反转"
                                            :isWork="DO_state_bitArray[9]" />
                                        <DIOStateDisplay class="group-item-DO" name="搅拌B正转"
                                            :isWork="DO_state_bitArray[10]" />
                                        <DIOStateDisplay class="group-item-DO" name="破碎压榨正转"
                                            :isWork="DO_state_bitArray[11]" />
                                        <DIOStateDisplay class="group-item-DO" name="破碎压榨反转"
                                            :isWork="DO_state_bitArray[12]" />
                                        <DIOStateDisplay class="group-item-DO" name="液压泵"
                                            :isWork="DO_state_bitArray[13]" />
                                        <DIOStateDisplay class="group-item-DO" name="不锈钢风机"
                                            :isWork="DO_state_bitArray[14]" />
                                        <DIOStateDisplay class="group-item-DO" name="喷淋塔电机"
                                            :isWork="DO_state_bitArray[15]" />
                                        <DIOStateDisplay class="group-item-DO" name="自吸式水泵"
                                            :isWork="DO_state_bitArray[16]" />
                                        <DIOStateDisplay class="group-item-DO" name="提升机上升"
                                            :isWork="DO_state_bitArray[17]" />
                                        <DIOStateDisplay class="group-item-DO" name="提升机下降"
                                            :isWork="DO_state_bitArray[18]" />
                                        <DIOStateDisplay class="group-item-DO" name="压榨冲洗"
                                            :isWork="DO_state_bitArray[19]" />
                                        <DIOStateDisplay class="group-item-DO" name="外接冲洗"
                        ...
                        <el-row gutter="10">
                            <el-col :span="18">
                                <div class="grid-content ep-bg-purple subbgcolor left-second-line shadow-border">
                                    <!-- 温度实时曲线 -->
                                    <LineChartStyle01 style="width: 100%; height: 110%;padding-top:10px"
                                        :input_temp1="AI_temp1_data" :input_temp2="AI_temp2_data"
                                        :input_temp3="AI_temp3_data" :input_time="AI_temp_time" />
                                </div>
                            </el-col>
                            <!-- //HACK:是否需要日期选择 -->
                                    ...
                                    <el-scrollbar height="90%">
                                        <el-timeline style="max-width: 600px ;height:100px">
                                            <el-timeline-item v-for="(activity, index) in activities" :key="index"
                                                ...
                                                <div v-if=activity.state style=" color: red ">{{ activity.content }}
                                                </div>
                        ...
                        <el-row>
                            <el-col :span="24">
                                <div class="grid-content ep-bg-purple subbgcolor right-row-line shadow-border">
                                    ...
                                    <BarChartStyle01 :_date=Dairy_list_date :_value=Dairy_list_value _title="日清单"
                                        _legend="重量(kg)" />
                                </div>
                            </el-col>
                        </el-row>
...
// let options = {
//   protocolVersion: someValue as (3 | 4 | 5 | undefined),
//   // 其他选项...
// };
const client: mqtt.MqttClient = mqtt.connect('ws://106.14.181.182:9001', options)
...
function readCoil() {
    ...
    // console.log(bytes)
    client.publish('/CJ2400101/SUBDIS', Buffer.from(bytes.buffer), { qos: 0, retain: false })
}
...
client.on('connect', () => {
    ...
    client.subscribe('/CJ2400101/WILL', { qos: 2 })
})
