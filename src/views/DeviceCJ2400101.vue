                        ...
                        <el-row>
                            <el-col :span="24">
                                <div class="grid-content ep-bg-purple subbgcolor right-row-line shadow-border">
                                    ...
                                    <BarChartStyle01 :_date=Dairy_list_date.values :_value=Dairy_list_value.values
                                        _title="日清单" _legend="重量(kg)" />
                                </div>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="24">
                                <div class="grid-content ep-bg-purple subbgcolor right-row-line shadow-border">
                                    ...
                                    <BarChartStyle01 :_date=Dairy_summary_date.values :_value=Dairy_summary_value.values
                                        _title="日汇总" _legend="重量(kg)" />
                                </div>
                            </el-col>
                        </el-row>
                    </div>
